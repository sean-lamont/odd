...
def generate_combined_latex_table(gsm_csv, he_csv, strategy_col, temp_col,
    ...
    # 2. Clean Data (Strictly pass_at_16)
    ...
    # Ensure names match lowercase standard
    target_strategy = target_strategy.lower()
    joint_strategy = joint_strategy.lower()

    # Filter only the 3 strategies we care about
    ...
    for i, dataset in enumerate(datasets):
        ...
        # Get maximum values per temperature column to bold the best results
