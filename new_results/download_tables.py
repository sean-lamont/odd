...
def fetch_wandb_data(entity, project, table_key_name="results_table"):
    ...
    for run in tqdm(runs, desc="Processing Runs"):
        ...
        try:
            ...
            group_key = 'question/task_id'  # if 'question' in df.columns else 'task_id'
...
if __name__ == "__main__":
    ...
    PROJECT = "dream_gsm8k_eval"
    TABLE_NAME = "results_table"
    FILENAME = "dream_gsm8k_table.json"
    ...
    PROJECT = "dream_humaneval_eval"
    TABLE_NAME = "results_table"
    FILENAME = "dream_humaneval_table.json"
